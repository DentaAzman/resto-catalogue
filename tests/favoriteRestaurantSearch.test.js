    ...
    it('should show the restaurants found by Favorite Restaurants', (done) => {
      document
        ...
        .addEventListener('restaurants:searched:updated', () => {
          expect(document.querySelectorAll('.resto-detail').length).toEqual(3);
    ...
    it('should show the name of the restaurants found by Favorite Restaurants', (done) => {
      document
        ...
        .addEventListener('restaurants:searched:updated', () => {
          ...
          expect(restaurantTitles.item(1).textContent).toEqual('resto def');
          expect(restaurantTitles.item(2).textContent).toEqual('resto ghi');
          done();
        });
  ...
  describe('When no favorite restaurants could be found', () => {
    ...
    it('should not show any restaurant', (done) => {
      document
        .getElementById('restaurant-search-container')
        .addEventListener('restaurants:searched:updated', () => {
          expect(document.querySelectorAll('.resto-detail').length).toEqual(0);
